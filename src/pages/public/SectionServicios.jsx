    ...
    <div className="fade-up">
      ...
      <div style={{ marginBottom:36 }}>
        ...
        <h1 style={{ fontFamily:'var(--ff-display)', fontWeight:900, fontSize:'clamp(34px,5vw,62px)', textTransform:'uppercase', lineHeight:.9, marginBottom:12 }}>
          Elige tu<br/><em style={{ color:'var(--gold)' }}>especialidad</em>
        </h1>
      </div>
              ...
              <div key={item.id} className="svc-row">
                ...
                {isExp && (
                  <div className="svc-row-expanded fade-in">
                    ...
                    {subs ? (
                      <div>
                        <div style={{ fontSize:11, color:'var(--gold)', fontWeight:700, textTransform:'uppercase', letterSpacing:'.1em', marginBottom:16 }}>Personaliza este servicio</div>
                        {subs.map(grupo => (
